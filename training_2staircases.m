function p = training_2staircases(p)
...
KbWait;
p.feedback = 0;
p.practice{7} = one_block_2staircases(p, 100,4,2,1); 
p.practice{8} = one_block_2staircases(p, 100,10,6,0);
p.contrast = p.practice{8}.contrastToUse;
